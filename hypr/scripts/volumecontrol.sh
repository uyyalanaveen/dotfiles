...
function notify_vol
{
    ...
    dunstify "t2" -a "$vol$bar" "myka" -i $ico -r 91190 -t 800
}
...
function notify_mute
{
    ...
    if [ "$mute" == "true" ] ; then
        dunstify "t2" -a "myka off" "" -i ${icodir}/muted-${dvce}.svg -r 91190 -t 800
    else
        dunstify "t2" -a "myka on" "" -i ${icodir}/unmuted-${dvce}.svg -r 91190 -t 800
    fi
}
